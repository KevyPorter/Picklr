...
public class ChatListener {
	...
	/*
	 * There can be multiple status's active at once, so we'll store these in a list
	 */
	...
	public void ClientChatReceivedEvent(ClientChatReceivedEvent event) 
	{
		...
		/*
		 * We now check the active status(s) and then fire their relevant event handlers
		 */
